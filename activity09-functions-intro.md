...
```
    ...
    ## Error in quantile_range(gapminder$lifeExp, probs = c(0.25, 0.75), type = 1): could not find function "quantile_range"

``` r
quantile_range(gapminder$lifeExp, probs = c(0.25, 0.75), type = 4)
```

    ## Error in quantile_range(gapminder$lifeExp, probs = c(0.25, 0.75), type = 4): could not find function "quantile_range"
